...
export
constexpr std::string_view BENCHPP_CLI_OPT_PRINT_ALL_BENCHMARKS = "-l";

/**@brief if nothing specified after will print all the groups
 * if a group is named it will print all info about said group
 */
export
constexpr std::string_view BENCHPP_CLI_OPT_PRINT_GROUP_INFOS = "-lg";

/**@brief follow this with the group name / names like group1 group2 etc.
 */
export
constexpr std::string_view BENCHPP_CLI_OPT_RUN_GROUP = "-g";

/**@brief follow this with the benchmark you want to run
 *        and the number of runs if you want to specify
 */
export
constexpr std::string_view BENCHPP_CLI_OPT_RUN_BENCHMARK = "-b";

export
constexpr std::string_view BENCHPP_CLI_OPT_HELP = "-h";
